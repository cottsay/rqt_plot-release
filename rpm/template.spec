...
Requires:       ros-eloquent-python-qt-binding >= 0.2.19
Requires:       ros-eloquent-qt-gui-py-common >= 0.2.25
Requires:       ros-eloquent-rclpy
Requires:       ros-eloquent-rqt-gui
Requires:       ros-eloquent-rqt-gui-py
Requires:       ros-eloquent-rqt-py-common
Requires:       ros-eloquent-std-msgs
...
%changelog
* Fri Sep 18 2020 Dirk Thomas <dthomas@osrfoundation.org> - 1.0.7-1
